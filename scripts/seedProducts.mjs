...
const products = [
  {
    name: 'Blazer de Lana Sastre', price: 125.0, status: 'disponible', badge: 'NUEVO', category: 'Abrigos', department: 'hombres', sizes: ['S', 'M', 'L'],
  ...
  {
    name: 'Pantalón Recto de Lino', price: 85.0, status: 'limitado', badge: 'STOCK LIMITADO', category: 'Pantalones', department: 'hombres', sizes: ['XS', 'S'],
  ...
  {
    name: 'Camisa de Seda Obsidiana', price: 75.0, status: 'disponible', category: 'Camisas', department: 'hombres', sizes: ['S', 'M', 'L', 'XL'],
  ...
  {
    name: 'Abrigo de Cashmere Camel', price: 320.0, status: 'agotado', category: 'Abrigos', department: 'hombres', sizes: ['M', 'L'],
  ...
  {
    name: 'Playera Pima Estructurada', price: 45.0, status: 'disponible', category: 'Camisas', department: 'hombres', sizes: ['XS', 'S', 'M', 'L', 'XL'],
  ...
  {
    name: 'Pantalón de Vestir Plisado', price: 110.0, status: 'disponible', category: 'Pantalones', department: 'hombres', sizes: ['S', 'M', 'L'],
  ...
  {
    name: 'Suéter de Cuello Alto', price: 68.0, status: 'disponible', category: 'Camisas', department: 'hombres', sizes: ['S', 'M', 'L'],
  ...
  {
    name: 'Chaqueta de Mezclilla', price: 95.0, status: 'disponible', category: 'Abrigos', department: 'hombres', sizes: ['M', 'L', 'XL'],
  ...
  {
    name: 'Pantalón Cargo Técnico', price: 78.0, status: 'disponible', category: 'Pantalones', department: 'hombres', sizes: ['S', 'M', 'L', 'XL'],
  ...
  {
    name: 'Camisa a Cuadros Franela', price: 52.0, status: 'limitado', badge: 'STOCK LIMITADO', category: 'Camisas', department: 'hombres', sizes: ['S', 'M'],
  ...
  {
    name: 'Abrigo Trench Impermeable', price: 210.0, status: 'disponible', category: 'Abrigos', department: 'hombres', sizes: ['M', 'L'],
  ...
  {
    name: 'Pantalón Jogger Elástico', price: 58.0, status: 'disponible', category: 'Pantalones', department: 'hombres', sizes: ['XS', 'S', 'M', 'L', 'XL'],
  ...
  {
    name: 'Camisa Oxford Rayada', price: 60.0, status: 'agotado', category: 'Camisas', department: 'hombres', sizes: ['S', 'M', 'L'],
  ...
  {
    name: 'Chaleco Acolchado', price: 88.0, status: 'disponible', badge: 'NUEVO', category: 'Abrigos', department: 'hombres', sizes: ['S', 'M', 'L'],
  ...
  {
    name: 'Vestido Midi de Seda', price: 145.0, status: 'disponible', badge: 'NUEVO', category: 'Vestidos', department: 'mujeres', sizes: ['XS', 'S', 'M'],
  ...
  {
    name: 'Blusa de Lino Ecru', price: 65.0, status: 'disponible', category: 'Blusas', department: 'mujeres', sizes: ['S', 'M', 'L'],
  ...
  {
    name: 'Falda Plisada Satinada', price: 95.0, status: 'limitado', badge: 'STOCK LIMITADO', category: 'Faldas', department: 'mujeres', sizes: ['XS', 'S'],
  ...
  {
    name: 'Vestido Camisero de Lino', price: 110.0, status: 'disponible', category: 'Vestidos', department: 'mujeres', sizes: ['S', 'M', 'L', 'XL'],
  ...
  {
    name: 'Blusa de Seda Manga Larga', price: 89.0, status: 'agotado', category: 'Blusas', department: 'mujeres', sizes: ['XS', 'S', 'M'],
  ...
  {
    name: 'Falda Recta de Lana', price: 99.0, status: 'disponible', category: 'Faldas', department: 'mujeres', sizes: ['S', 'M', 'L'],
  ...
  {
    name: 'Vestido Largo Floral', price: 130.0, status: 'disponible', category: 'Vestidos', department: 'mujeres', sizes: ['S', 'M', 'L'],
  ...
  {
    name: 'Blusa Cropped de Algodón', price: 52.0, status: 'disponible', category: 'Blusas', department: 'mujeres', sizes: ['XS', 'S', 'M'],
  ...
  {
    name: 'Falda Midi de Denim', price: 72.0, status: 'disponible', category: 'Faldas', department: 'mujeres', sizes: ['S', 'M', 'L'],
  ...
  {
    name: 'Vestido Envolvente de Punto', price: 98.0, status: 'limitado', badge: 'STOCK LIMITADO', category: 'Vestidos', department: 'mujeres', sizes: ['S', 'M'],
  ...
  {
    name: 'Blusa Satinada Escote V', price: 75.0, status: 'disponible', category: 'Blusas', department: 'mujeres', sizes: ['XS', 'S', 'M', 'L'],
  ...
  {
    name: 'Falda Lápiz Formal', price: 85.0, status: 'agotado', category: 'Faldas', department: 'mujeres', sizes: ['S', 'M', 'L'],
  ...
  {
    name: 'Vestido Camisero Rayado', price: 105.0, status: 'disponible', category: 'Vestidos', department: 'mujeres', sizes: ['XS', 'S', 'M', 'L', 'XL'],
  ...
  {
    name: 'Blusa Bordada Artesanal', price: 92.0, status: 'disponible', badge: 'NUEVO', category: 'Blusas', department: 'mujeres', sizes: ['S', 'M'],
  ...
  {
    name: 'Bolso Tote de Cuero', price: 180.0, status: 'disponible', badge: 'NUEVO', category: 'Bolsos', department: 'accesorios', sizes: ['Único'],
  ...
  {
    name: 'Cinturón de Cuero Clásico', price: 55.0, status: 'disponible', category: 'Cinturones', department: 'accesorios', sizes: ['Único'],
  ...
  {
    name: 'Collar Minimalista de Oro', price: 70.0, status: 'limitado', badge: 'STOCK LIMITADO', category: 'Joyería', department: 'accesorios', sizes: ['Único'],
  ...
  {
    name: 'Bolso Crossbody Camel', price: 135.0, status: 'disponible', category: 'Bolsos', department: 'accesorios', sizes: ['Único'],
  ...
  {
    name: 'Cinturón Trenzado', price: 48.0, status: 'agotado', category: 'Cinturones', department: 'accesorios', sizes: ['Único'],
  ...
  {
    name: 'Aretes Geométricos de Plata', price: 40.0, status: 'disponible', category: 'Joyería', department: 'accesorios', sizes: ['Único'],
  ...
  {
    name: 'Bolso Bandolera Mini', price: 95.0, status: 'disponible', category: 'Bolsos', department: 'accesorios', sizes: ['Único'],
  ...
  {
    name: 'Cinturón Reversible', price: 60.0, status: 'disponible', category: 'Cinturones', department: 'accesorios', sizes: ['Único'],
  ...
  {
    name: 'Pulsera de Cuero Trenzado', price: 35.0, status: 'disponible', category: 'Joyería', department: 'accesorios', sizes: ['Único'],
  ...
  {
    name: 'Bolso Clutch de Noche', price: 110.0, status: 'limitado', badge: 'STOCK LIMITADO', category: 'Bolsos', department: 'accesorios', sizes: ['Único'],
  ...
  {
    name: 'Cinturón Ancho de Charol', price: 65.0, status: 'disponible', category: 'Cinturones', department: 'accesorios', sizes: ['Único'],
  ...
  {
    name: 'Anillo Minimalista de Plata', price: 32.0, status: 'disponible', category: 'Joyería', department: 'accesorios', sizes: ['Único'],
  ...
  {
    name: 'Bolso Baguette Textil', price: 88.0, status: 'agotado', category: 'Bolsos', department: 'accesorios', sizes: ['Único'],
  ...
  {
    name: 'Cinturón Doble Hebilla', price: 58.0, status: 'disponible', badge: 'NUEVO', category: 'Cinturones', department: 'accesorios', sizes: ['Único'],
...
for (const product of products) {
  ...
  batch.set(ref, { ...product, createdAt: FieldValue.serverTimestamp() })
}
batch.set(db.collection('settings').doc('policies'), {
  shipping:
...
console.log(`Se agregaron ${products.length} productos y las políticas de la tienda a Firestore.`)
process.exit(0)
